...
export default function ProviderPaymentsPage() {
  ...
  const loadPayments = async () => {
    try {
      ...
      const data = await paymentService.getProviderPayments(status);
      setPayments(data);
    } catch (err) {
  ...
  return (
    <div className="w-full">
      {/* Sub-header */}
      <div className="mb-6">
        <p className="text-gray-400">View and manage all payments for your services</p>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
          ...
          <div className="bg-gray-800 rounded-lg p-4 border border-gray-700">
            ...
            <p className="text-2xl font-bold text-blue-400">KES {stats.totalAmount.toLocaleString()}</p>
          </div>
        </div>
          ...
          <div className="flex flex-col md:flex-row gap-4">
            <div className="flex-1">
              <div className="relative">
                ...
                <input
                  type="text"
                  placeholder="Search by service, amount, or payment number..."
                  value={searchQuery}
