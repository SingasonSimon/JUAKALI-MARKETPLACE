      ...
      >
            ...
            <div className={`p-4 border-b border-gray-700/50 ${sidebarCollapsed ? 'px-2' : ''}`}>
              <div className={`flex items-center ${sidebarCollapsed ? 'justify-center' : 'gap-3'} mb-3`}>
                ...
                <div className={`w-11 h-11 rounded-full bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center text-white font-semibold text-base flex-shrink-0 shadow-lg ring-2 ring-blue-500/20 ${dbUser?.profile_image ? 'hidden' : ''}`}>
        ...
        <header className="bg-gray-800 border-b border-gray-700 px-4 sm:px-6 py-4 flex items-center justify-between sticky top-0 z-40 shadow-md flex-shrink-0">
          ...
          <div className="relative" ref={profileMenuRef}>
            ...
            >
              ...
              <div className={`w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center text-white font-bold text-sm sm:text-base flex-shrink-0 ${dbUser?.profile_image ? 'hidden' : ''}`}>
                {dbUser?.first_name?.[0]?.toUpperCase() || 'U'}
              </div>
